    ...
    <div class="container" style="padding: 112px;">
        <form method="post" action="insert.php" style="background: var(--bs-dark);">
            <div style="padding: 87px;margin: 6px;">
                ...
                <div>
                    <input class="form-control" type="text" name="name" placeholder="Full Name" style="padding: 6px 12px;margin: 14px;">
                </div>
                <div>
                    <input class="form-control" type="text" name="address" placeholder="Address" style="margin: 14px;">
                </div>
                <div>
                    <input class="form-control" type="text" name="number" placeholder="Phone Number" style="margin: 14px;">
                </div>
                <div>
